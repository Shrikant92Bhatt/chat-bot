...
- Name: auth-session.spec.ts >> Google OAuth2 & Session Exchange Authentication E2E Suite >> should verify GET /api/auth/session returns JSON service health
- Location: e2e\auth-session.spec.ts:4:7
